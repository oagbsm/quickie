...
const options = [["Customer help", "Questions about a submitted job or booking.", "/contact"], ["Professional help", "Questions about joining or using Quickola as a professional.", "/for-providers"], ["Account help", "Sign in to the Quickola portal or get help with access.", "/auth/portal"], ["Contact support", "Send the Quickola team a message.", "/contact"]];
