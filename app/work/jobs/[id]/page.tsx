...
export default async function WorkJobPage({ params, searchParams }: { params: Promise<{ id: string }>; searchParams: Promise<{ error?: string; sent?: string }> }) {
  ...
  const issueBeingReviewed = Boolean(booking && (booking.completion_status === "issue_reported" || activeDispute || (booking.payout_hold_status === "held" && booking.payout_hold_reason === "unresolved_dispute")));
