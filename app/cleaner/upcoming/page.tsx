...
export default async function Page() {
  ...
  const { data } = worker
    ...
    : { data: [] };
  return <><p className="text-sm font-extrabold text-[#2d67b2]">YOUR WORK</p><h1 className="mt-1 text-3xl font-extrabold">Upcoming</h1><TurnoverCards items={data || []} empty="No upcoming turnovers assigned." /></>;
}
