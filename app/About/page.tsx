...
export const metadata: Metadata = {
  ...
  description:
    "Quickola is an early Slough cleaning fair-price discovery and request-routing service. Learn what Quickola does, how it helps customers, how outside providers are considered and how the service works.",
  alternates: {
    canonical: "/about",
  },
  openGraph: {
    ...
    description:
      "Quickola helps people check fair local cleaning prices before booking, then routes requests where suitable help is available during its early Slough launch.",
    url: "/about",
    siteName: "Quickola",
    type: "website",
  },
...
const customerSteps = [
  "Tell Quickola what type of clean you need and where in Slough you need it.",
  "See a fair guide range and the main factors that can affect the price.",
  "Send a WhatsApp request if you want help checking availability.",
  "Quickola reviews the request and routes it where suitable help is available.",
];

const providerSteps = [
  "Cleaning providers can apply with their business name, WhatsApp number, starting price and areas covered.",
  "Quickola reviews available provider details before any outside customer referral is made.",
  "Suitable cleaning providers may receive relevant customer requests by WhatsApp where available.",
  "Future visibility is intended to be based on fit, responsiveness, price clarity and customer feedback — not paid ranking.",
];
...
const whatQuickolaIsNot = [
  ...
  "Quickola is not a mature national provider network yet; it is in early Slough cleaning launch mode.",
...
const faqs = [
  {
    ...
    answer:
      "Quickola is an early Slough cleaning fair-price discovery and request-routing service. It helps people understand fair local cleaning price ranges before booking, then routes requests where suitable help is available.",
  },
  {
  ...
  {
    question: "How does Quickola consider providers?",
    answer:
      "Quickola is in early Slough launch mode, so coverage may be limited. When outside providers are used, Quickola reviews available provider details and considers service fit, postcode coverage, starting prices, responsiveness and customer feedback. Quickola does not sell paid ranking as the basis for visibility.",
  },
  {
    question: "Is every Quickola price a final quote?",
    answer:
      "No. Quickola price ranges are guide ranges. Final prices depend on job details, access, urgency, parking, travel, property condition, extras requested and provider availability.",
  },
  {
    question: "Where is Quickola launching?",
    answer:
      "Quickola is starting with cleaning requests in Slough and nearby SL postcodes before expanding more widely.",
  },
];
  ...
  "@graph": [
    {
      ...
      description:
        "Quickola is an early Slough cleaning fair-price discovery and request-routing service that helps people understand fair local cleaning prices before booking.",
      contactPoint: {
        "@type": "ContactPoint",
    ...
    },
    {
      ...
      description:
        "About Quickola, an early Slough cleaning fair-price discovery and request-routing service.",
      mainEntity: {
        "@type": "Organization",
        name: "Quickola",
      },
    ...
    <main className="min-h-screen bg-[#f7f9fb] text-[#071638]">
        ...
        <div className="mx-auto grid max-w-[1240px] gap-10 px-5 py-16 sm:px-8 lg:grid-cols-[1.1fr_0.9fr] lg:px-10 lg:py-24">
          <div>
            ...
            <p className="mt-6 max-w-[730px] text-[18px] font-semibold leading-[1.65] text-[#44506a] sm:text-[21px]">
              Quickola is an early Slough cleaning fair-price discovery and request-routing service. We help people check what a clean should reasonably cost before they book, then route requests where suitable help is available.
            </p>
          ...
          <Card>
            ...
            <p className="mt-4 text-[16px] font-semibold leading-[1.65] text-[#44506a]">
              Instead of starting with a long list of providers, Quickola starts with the customer’s biggest question: what is a fair price for this clean in Slough?
            </p>
            <div className="mt-6 grid gap-3 text-[14px] font-extrabold text-[#44506a]">
              ...
              <div className="rounded-[16px] bg-[#f3f6ff] p-4 ring-1 ring-[#dce4ff]">Request routing based on fit and availability</div>
      ...
      <section className="mx-auto max-w-[1240px] px-5 py-14 sm:px-8 lg:px-10">
        <div className="max-w-[800px]">
          ...
          <h2 className="mt-3 text-[34px] font-black leading-[1.05] tracking-[-0.035em] sm:text-[48px]">
            We make local cleaning prices easier to understand.
          </h2>
          <p className="mt-4 text-[17px] font-semibold leading-[1.65] text-[#44506a]">
            Cleaning quotes can change because of property size, clean type, condition, urgency, parking, travel time, access, extras and availability. Quickola explains those price factors before a customer moves forward.
          </p>
        </div>
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-3">
          <Card>
            ...
            <p className="mt-3 text-[15px] font-semibold leading-[1.6] text-[#44506a]">
              Quickola gives customers a fair local cleaning guide range so they have a realistic starting point before speaking to anyone.
            </p>
          </Card>
          <Card>
            <h3 className="text-[22px] font-black tracking-[-0.02em]">Local request routing</h3>
            <p className="mt-3 text-[15px] font-semibold leading-[1.6] text-[#44506a]">
              Where suitable help is available, Quickola can help route cleaning requests based on area, availability and request details.
            </p>
          </Card>
          <Card>
            <h3 className="text-[22px] font-black tracking-[-0.02em]">Provider quality signals</h3>
            <p className="mt-3 text-[15px] font-semibold leading-[1.6] text-[#44506a]">
              When outside providers are used, available provider details are reviewed before referral. Future visibility is intended to consider fit, response speed, price clarity and customer feedback.
            </p>
          </Card>
        </div>
      </section>
      ...
      <section className="border-y border-[#e1e8f0] bg-white">
        ...
        <div className="max-w-[780px]">
          ...
          <h2 className="mt-3 text-[34px] font-black leading-[1.05] tracking-[-0.035em] sm:text-[48px]">
            Built for cleaning jobs where price confidence matters.
          </h2>
          <p className="mt-4 text-[17px] font-semibold leading-[1.65] text-[#44506a]">
            Quickola is starting with cleaning in Slough: regular domestic cleans, deep cleans, end-of-tenancy cleans, Airbnb turnovers and after-builders cleans. Other categories may be added later when provider coverage is ready.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-[1240px] px-5 py-14 sm:px-8 lg:px-10">
        <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
          <div>
            ...
            <p className="mt-4 text-[17px] font-semibold leading-[1.65] text-[#44506a]">
              Quickola is a new UK digital service starting with cleaning in Slough. As the service grows, public trust signals, provider feedback and customer outcomes will be added transparently rather than invented.
            </p>
          </div>
        ...
        <div className="mx-auto flex max-w-[1240px] flex-col gap-5 px-5 py-12 sm:px-8 lg:flex-row lg:items-center lg:justify-between lg:px-10">
          <div>
            ...
            <p className="mt-2 max-w-[760px] text-[16px] font-semibold leading-[1.6] text-[#44506a]">
              Check a fair local cleaning price before you book.
            </p>
          </div>
