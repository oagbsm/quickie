...
export default function HomepageHero({
  ...
  return (
    <>
      <section
        className="relative bg-[#061b3f] px-4 pb-[56px] pt-4 text-white md:min-h-0 md:px-5 md:py-8 lg:min-h-[380px] lg:px-8 lg:py-0"
      >
        <div className="mx-auto grid max-w-[1240px] gap-0 lg:min-h-[380px] lg:grid-cols-[1.05fr_.95fr] lg:items-start lg:gap-12 lg:pt-[30px]">
          <div className="relative z-10 min-w-0 max-w-[340px] md:max-w-none">
            ...
            <h1 className="mt-2 max-w-[680px] text-balance text-[2.5rem] font-black leading-[1] tracking-[-.04em] md:mt-4 md:text-6xl md:tracking-[-.055em] lg:text-[54px] lg:leading-[.98]">
              Help around the house, <span className="text-[#23dc63]">when you need it.</span>
            </h1>
            <p className="mt-3 max-w-[245px] text-[15.5px] leading-[1.45] text-white/90 md:mt-5 md:max-w-[680px] md:text-[18px] md:leading-8 lg:text-[17px] lg:leading-7">
          ...
          <div className="relative hidden min-h-[360px] items-end justify-center lg:flex">
            <Image
              ...
              height={760}
              priority
              className="relative z-10 h-auto w-[207px] max-w-full max-h-none -translate-y-[75px] object-contain drop-shadow-[0_28px_45px_rgba(0,0,0,.3)]"
            />
      ...
      <div
        className="relative z-20 mx-auto -mt-14 w-full max-w-[1200px] px-4 pb-8 md:-mt-20 md:px-8 lg:-mt-[115px] lg:px-0 lg:pb-0"
      >
        <ConsumerJobComposer
