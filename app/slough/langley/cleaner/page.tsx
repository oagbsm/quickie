...
const pageData = {
  "title": "Cleaner in Langley | Fair Cleaning Prices",
  ...
  "intro": "Looking for a cleaner in Langley? Quickola helps local residents check fair cleaning prices before booking. We are currently focused on cleaning requests in Slough and nearby SL postcodes.",
