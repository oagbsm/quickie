...
const pageData = {
  "title": "Cleaner in Upton | Fair Cleaning Prices",
  "description": "Looking for a cleaner in Upton? Check fair local cleaning prices for regular cleans, deep cleans, end-of-tenancy and more before booking.",
  "h1": "Cleaner in Upton",
  "intro": "Looking for a cleaner in Upton? Quickola helps local residents check fair cleaning prices before booking. We are currently focused on cleaning requests in Slough and nearby SL postcodes.",
  "localNote": "Upton and central Slough cleaning requests can include flats, shared homes, rental move-outs and short-notice deep cleans. Parking, lift access and property condition can affect the final price.",
  "priceTitle": "Upton cleaner guide price",
  "priceRange": "from £35+",
  "priceNotes": [
  ...
  "canonical": "/slough/upton/cleaner",
  "area": "Upton"
} as const;
