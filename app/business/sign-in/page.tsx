...
export const metadata:Metadata={title:"Business sign in | Quickola",description:"Sign in to your Quickola business cleaning account.",robots:{index:false,follow:false},alternates:{canonical:"/business/sign-in"}};
