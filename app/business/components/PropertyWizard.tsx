              ...
              <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-4">
                {providerOptions.map((option) => (
                  ...
                  >
                    ...
                    />
                    {option.value === "airbnb" && <span className="flex h-[48px] w-full max-w-[148px] items-center justify-center overflow-hidden"><Image src="/icons/airbnb.png" alt="" aria-hidden="true" width={135} height={48} className="h-auto max-h-[48px] w-auto max-w-[135px] object-contain object-center" style={{ maxWidth: "100%" }} /></span>}
                    {option.value === "booking_com" && <span className="flex h-[48px] w-full max-w-[148px] items-center justify-center overflow-hidden"><Image src="/icons/booking.jpg" alt="" aria-hidden="true" width={148} height={45} className="h-auto max-h-[45px] w-auto max-w-[148px] object-contain object-center" style={{ maxWidth: "100%" }} /></span>}
                    {option.value === "vrbo" && <span className="flex h-[48px] w-full max-w-[148px] items-center justify-center overflow-hidden"><Image src="/icons/vrbo.png" alt="" aria-hidden="true" width={135} height={48} className="h-auto max-h-[48px] w-auto max-w-[135px] object-contain object-center" style={{ maxWidth: "100%" }} /></span>}
                    {option.value === "expedia" && <span className="flex h-[48px] w-full max-w-[148px] items-center justify-center overflow-hidden"><Image src="/icons/expedia.png" alt="" aria-hidden="true" width={135} height={48} className="h-auto max-h-[48px] w-auto max-w-[135px] object-contain object-center" style={{ maxWidth: "100%" }} /></span>}
