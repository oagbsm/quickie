-- A first unpaid selection must not make otherwise valid offers irreversible.
-- Withdrawn and expired offers remain unavailable; declined is the historical
-- status used for competing offers during pre-payment selection.
